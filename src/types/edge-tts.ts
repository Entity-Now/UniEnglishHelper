import type { EdgeTTSRequestParams, EdgeTTSVoice } from '@/utils/edge-tts/types';
...
export type EdgeTTSSynthesizeResponse =
  | EdgeTTSSynthesizeSuccess
  | EdgeTTSSynthesizeFailure;
...
export type EdgeTTSSynthesizeWireResponse =
  | EdgeTTSSynthesizeWireSuccess
  | EdgeTTSSynthesizeFailure;
